...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
        ...
        <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="/JEE_PROJECT_V2">Employees Management</a>
            <div class="collapse navbar-collapse" id="navbarText">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="btn btn-light" href="logout" style="color: black; font-size: 8px; font-size: 1.2vw;">
                            Log out
                            <span style="
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="btn btn-light" href="login" style="color: black; font-size: 8px; font-size: 1.2vw;">
                            Log in
                            <span style="
