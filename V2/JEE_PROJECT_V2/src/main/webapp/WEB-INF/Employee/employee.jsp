            ...
            <div class="row">
                <div class="col">
                    ...
                    <form action="Controller_Employee_PUT" method="POST">                            
                        ...
                        <div class="form-group row">
                            <div class="col-sm-1"></div>
                            <label for="<%=Constants.FORM_EMPLOYEE_FIRST_NAME%>" class="col-sm-2 col-form-label" style="text-align: right;">Pr�nom</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="<%=Constants.FORM_EMPLOYEE_FIRST_NAME%>" id="<%=Constants.FORM_EMPLOYEE_FIRST_NAME%>" placeholder="Pr�nom"
                                       <c:if test="${not empty employee}">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-1"></div>
                            <label for="<%=Constants.FORM_EMPLOYEE_HOME_PHO%>" class="col-sm-2 col-form-label" style="text-align: right;">T�l dom</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="<%=Constants.FORM_EMPLOYEE_HOME_PHO%>" id="<%=Constants.FORM_EMPLOYEE_HOME_PHO%>" placeholder="T�l dom"
                                       <c:if test="${not empty employee}">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-1"></div>
                            <label for="<%=Constants.FORM_EMPLOYEE_MOB_PHO%>" class="col-sm-2 col-form-label" style="text-align: right;">T�l mob</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="<%=Constants.FORM_EMPLOYEE_MOB_PHO%>" id="<%=Constants.FORM_EMPLOYEE_MOB_PHO%>" placeholder="T�l mob"
                                       <c:if test="${not empty employee}">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-1"></div>
                            <label for="<%=Constants.FORM_EMPLOYEE_PRO_PHO%>" class="col-sm-2 col-form-label" style="text-align: right;">T�l pro</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="<%=Constants.FORM_EMPLOYEE_PRO_PHO%>" id="<%=Constants.FORM_EMPLOYEE_PRO_PHO%>" placeholder="T�l pro"
                                       <c:if test="${not empty employee}">
